...
public class VentanaJTableAlumnosRowSetEventos extends JFrame implements ListSelectionListener,RowSetListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJTableAlumnosRowSetEventos frame = new VentanaJTableAlumnosRowSetEventos();
	...
	// JFrame
	public VentanaJTableAlumnosRowSetEventos() {
      ...
      crs.close();
		...
		try {
			crs.moveToInsertRow();
	    crs.updateString("dni", "90000000A");
