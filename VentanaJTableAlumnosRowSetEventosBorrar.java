...
public class VentanaJTableAlumnosRowSetEventosBorrar extends JFrame implements ListSelectionListener,RowSetListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJTableAlumnosRowSetEventosBorrar frame = new VentanaJTableAlumnosRowSetEventosBorrar();
	...
	// JFrame
	public VentanaJTableAlumnosRowSetEventosBorrar() {
      ...
      crs.close();
		...
		// borro un registro
		// System.out.println("Borro un registro");
		try {
			...
			// sqle.printStackTrace();
			System.out.println("Error. No se ha podido borrar el registro");
		}
