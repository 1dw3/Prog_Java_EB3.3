...
public class VentanaJTableAlumnosRowSetEventosInsertar extends JFrame implements ListSelectionListener,RowSetListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJTableAlumnosRowSetEventosInsertar frame = new VentanaJTableAlumnosRowSetEventosInsertar();
	...
	// JFrame
	public VentanaJTableAlumnosRowSetEventosInsertar() {
