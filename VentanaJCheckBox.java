...
public class VentanaJCheckBox extends JFrame implements ChangeListener,ActionListener{
	...
	public VentanaJCheckBox() {
		...
		lblTexto = new JLabel("Proba testua");
