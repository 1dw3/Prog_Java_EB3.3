...
public class VentanaJFileChooserSave extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJFileChooserSave frame = new VentanaJFileChooserSave();
	...
	// JFrame
	public VentanaJFileChooserSave() {
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				// muestro el fileChooser para Guardar
